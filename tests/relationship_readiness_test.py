...
questions = [
    {
        ...
        "options": {
            "الف": "سعی می کنم سریعا بحث را تمام کنم\nو به توافق برسیم، حتی اگر به طور کامل متقاعد نشده باشم.",
            "ب": "با دقت به نظر او گوش می دهم،\nسعی می کنم دیدگاهش را درک کنم و سپس نظر خود را با احترام بیان می کنم.",
            "ج": "احساس ناراحتی می کنم\nو ممکن است کمی سکوت کنم تا از بحث بیشتر جلوگیری شود.",
            "د": "فورا سعی می کنم او را متقاعد کنم\nکه اشتباه می کند و نظر من درست است.",
            "ه": "بسته به موضوع، گاهی با دقت گوش می دهم\nو گاهی هم سریع بحث را تمام می کنم."
        },
        "scores": {
            "الف": 1,
            "ب": 5,
