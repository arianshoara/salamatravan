...
questions = [
    ...
    "options": {
        "الف": "به شدت عصبانی می شوم\nرابطه را تمام می کنم، دروغ نابخشودنی.",
        "ب": "ناراحت/بی اعتماد می شوم\nوانمود می کنم چیزی نشده.",
        "ج": "آرام می باشم\nصحبت می کنم، دلیلش را می فهمم، بخشش را بررسی می کنم.",
    ...
    "options": {
        ...
        "ج": "صحبت می کنم\nپشیمانی اش را می سنجم، بخشش را بررسی می کنم.",
        "د": "فرصت جبران می دهم\nمطمئن نیستم ببخشم.",
    ...
    },
    {
        ...
        "options": {
            "الف": "وفاداری ظاهری و پرهیز از خیانت\nبه هر قیمتی.",
            "ب": "حمایت مالی و تامین نیازهای زندگی\nشریک زندگی.",
            "ج": "صداقت، اعتماد، وفاداری عاطفی و\nتلاش برای حفظ رابطه در بلندمدت.",
            "د": "رعایت رسوم و تعهدات اجتماعی و خانوادگی\nحتی اگر رابطه رضایت بخش نباشد.",
            "ه": "بسته به تعریف شخصی از تعهد و شرایط رابطه،\nجنبه های مختلفی می تواند مهم باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 2,
    ...
    },
    {
        ...
        "options": {
            "الف": "احساس می کنم باید بیشتر تلاش کنم\nتا شبیه آن فرد شوم و رضایت او را جلب کنم.",
            "ب": "فورا ناراحت و عصبانی می شوم\nو به او می گویم که مقایسه کردن کار درستی نیست.",
            "ج": "با آرامش از او می پرسم\nچرا مرا مقایسه می کند و چه انتظاراتی دارد.",
            "د": "ممکن است سکوت کنم\nو از او فاصله بگیرم، چون احساس می کنم کافی نیستم.",
    ...
    },
    {
        ...
        "options": {
            "الف": "بهانه های او را می پذیرم\nو فکر می کنم حتما دلیلی داشته که نتوانسته به وعده اش عمل کند.",
            "ب": "فورا ناامید و دلخور می شوم\nو احساس می کنم به من اهمیت نمی دهد.",
            "ج": "با او صحبت می کنم\nو به طور واضح توضیح می دهم که بدقولی او مرا ناراحت می کند و اعتمادم را کم می کند.",
            "د": "دیگر به وعده هایش اعتماد نمی کنم\nو انتظار زیادی از او ندارم.",
            "ه": "بسته به نوع وعده و میزان تکرار آن،\nواکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 2,
