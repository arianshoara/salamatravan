...
questions = [
    {
        ...
        "options": {
            "الف": "سعی می کنم سریعا بحث را تمام کنم و به توافق برسیم، حتی اگر به طور کامل متقاعد نشده باشم.",
            "ب": "با دقت به نظر او گوش می دهم، سعی می کنم دیدگاهش را درک کنم و سپس نظر خود را با احترام بیان می کنم.",
            "ج": "احساس ناراحتی می کنم و ممکن است کمی سکوت کنم تا از بحث بیشتر جلوگیری شود.",
            "د": "فورا سعی می کنم او را متقاعد کنم که اشتباه می کند و نظر من درست است.",
            "ه": "بسته به موضوع، گاهی با دقت گوش می دهم و گاهی هم سریع بحث را تمام می کنم."
        },
        "scores": {
            "الف": 1,
            "ب": 5,
    ...
    },
    {
        ...
        "options": {
            "الف": "فورا ناراحت می شوم و با او دعوا می کنم که چرا اخلاقش بد است.",
            "ب": "سعی می کنم به او فضا بدهم و امیدوار باشم خودش حالش بهتر شود.",
            "ج": "نگران می شوم و سعی می کنم بفهمم چه مشکلی دارد و چطور می توانم کمکش کنم.",
            "د": "تصمیم می گیرم که این مشکل اوست و به من ربطی ندارد و به زندگی خودم ادامه می دهم.",
            "ه": "اخلاق بد او را تحمل می کنم، اما در ذهنم از او ناراحت می شوم و ممکن است بعدا در موردش با دوست صمیمی ام صحبت کنم."
        },
        "scores": {
            "الف": 1,
            "ب": 2,
    ...
    },
    {
        ...
        "options": {
            "الف": "هیجان و جذابیت اولیه و داشتن لحظات پرشور.",
            "ب": "امنیت، اعتماد و احساس آرامش و اطمینان در کنار شریک زندگی.",
            "ج": "داشتن علایق و سرگرمی های مشترک و گذراندن اوقات خوش با هم.",
            "د": "پیشرفت فردی و رسیدن به اهداف شخصی با حمایت شریک زندگی.",
            "ه": "بسته به شرایط و فرد مقابل، اولویت هایم ممکن است متفاوت باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 5,
    ...
    },
    {
        ...
        "options": {
            "الف": "فورا حالت تدافعی می گیرم و سعی می کنم از خودم دفاع کنم.",
            "ب": "احساس ناراحتی می کنم، اما سعی می کنم چیزی نشان ندهم و فقط گوش کنم.",
            "ج": "سعی می کنم آرام باشم و از او بپرسم دقیقا منظورش چیست و چطور می توانم بهتر شوم.",
            "د": "انتقاد او را نادیده می گیرم و فکر می کنم او فقط می خواهد مرا اذیت کند.",
            "ه": "بسته به نوع انتقاد و حالم، گاهی تدافعی می شوم و گاهی سعی می کنم گوش کنم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "به شدت عصبانی می شوم و رابطه را فورا تمام می کنم، چون دروغ غیرقابل بخشش است.",
            "ب": "احساس ناراحتی و بی اعتمادی می کنم، اما سعی می کنم به روی خودم نیاورم و وانمود کنم چیزی نشده.",
            "ج": "سعی می کنم آرام باشم و با او صحبت کنم تا دلیل دروغش را بفهمم و ببینم آیا امکان بخشش وجود دارد.",
            "د": "فورا اعتمادم را به او از دست می دهم و دیگر هیچ وقت به حرف هایش باور نخواهم کرد.",
            "ه": "بسته به نوع دروغ و شرایط، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "توانایی متقاعد کردن شریک زندگی به انجام کارهایی که می خواهم.",
            "ب": "توانایی تعریف و تمجید از شریک زندگی و ابراز علاقه به او.",
            "ج": "توانایی گوش دادن فعال و همدلانه به حرف های شریک زندگی.",
            "د": "توانایی بحث کردن و برنده شدن در بحث ها با شریک زندگی.",
            "ه": "توانایی حدس زدن نیازها و خواسته های شریک زندگی بدون اینکه نیاز باشد او چیزی بگوید."
        },
        "scores": {
            "الف": 1,
            "ب": 3,
    ...
    },
    {
        ...
        "options": {
            "الف": "فورا ناراحت و ناامید می شوم و ممکن است به فکر جدایی بیفتم.",
            "ب": "سعی می کنم این احساس را نادیده بگیرم و خودم را مشغول چیزهای دیگر کنم تا یادم برود.",
            "ج": "به آرامی با شریک زندگی خود صحبت می کنم و احساسات و نیازهایم را به طور واضح بیان می کنم.",
            "د": "سکوت می کنم و امیدوارم شریک زندگی ام خودش متوجه شود و رفتارش را تغییر دهد.",
            "ه": "بسته به میزان نارضایتی ام و شرایط، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "در یک رابطه صمیمانه، هیچ حریم شخصی نباید وجود داشته باشد و همه چیز باید با هم مشترک باشد.",
            "ب": "حریم شخصی بسیار مهم است و هر فرد باید بتواند کاملا مستقل از رابطه، زندگی شخصی خود را داشته باشد.",
            "ج": "مقدار حریم شخصی باید متعادل باشد؛ هر دو طرف باید احساس راحتی و نزدیکی داشته باشند، اما فضای فردی هم حفظ شود.",
            "د": "حریم شخصی بستگی به نوع رابطه دارد؛ در روابط جدی باید حریم شخصی کمتری وجود داشته باشد.",
            "ه": "بسته به شخصیت و نیازهای فردی، میزان حریم شخصی می تواند متفاوت باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "بخشیدن اشتباه بزرگ غیرممکن است و رابطه را فورا تمام می کنم.",
            "ب": "می گویم او را می بخشم، اما در واقع هیچ وقت نمی توانم اعتمادم را به او برگردانم.",
            "ج": "سعی می کنم با او صحبت کنم، عمق پشیمانی اش را بسنجم و ببینم آیا می توانم ببخشم و رابطه را ترمیم کنم.",
            "د": "به او فرصت می دهم تا جبران کند، اما مطمئن نیستم که بتوانم او را کاملا ببخشم.",
            "ه": "بسته به نوع اشتباه و میزان آسیب، تصمیم متفاوتی می گیرم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "خانواده ها باید نقش اصلی را داشته باشند و تصمیمات مهم رابطه باید با مشورت و تایید آنها گرفته شود.",
            "ب": "خانواده ها نباید هیچ دخالتی داشته باشند و رابطه باید کاملا بین دو نفر باشد.",
            "ج": "خانواده ها می توانند نقش حمایتی و مشورتی داشته باشند، اما تصمیم نهایی باید با زوج باشد.",
            "د": "نقش خانواده ها بستگی به فرهنگ و سنت های خانوادگی دارد.",
            "ه": "بسته به میزان صمیمیت با خانواده ها و نیازهای فردی، نقش خانواده ها می تواند متفاوت باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "ترجیح می دهم مشکلاتم را خودم حل کنم و نمی خواهم شریک زندگی ام را با آنها درگیر کنم.",
            "ب": "ممکن است کمی بدخلق و کم حوصله شوم، اما انتظار دارم شریک زندگی ام خودش متوجه شود و به من توجه کند.",
            "ج": "به شریک زندگی ام می گویم که استرس دارم و نیاز به حمایت و درک او دارم.",
            "د": "ممکن است سکوت کنم و از او فاصله بگیرم تا بتوانم با مشکلاتم کنار بیایم.",
            "ه": "بسته به نوع مشکل و حالم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "رفتار او را تحمل می کنم و امیدوارم خودش متوجه اشتباهش شود و تغییر کند.",
            "ب": "فورا ناراحت می شوم و رابطه را تمام می کنم، چون نمی توانم با رفتاری که با ارزش هایم مغایر است کنار بیایم.",
            "ج": "با او صحبت می کنم و به طور واضح توضیح می دهم که چرا این رفتار برایم قابل قبول نیست و چه احساسی دارم.",
            "د": "ممکن است سکوت کنم و از او فاصله بگیرم تا ناراحتی ام کمتر شود.",
            "ه": "بسته به نوع رفتار و میزان مغایرت با ارزش هایم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "احساس می کنم نادیده گرفته شده ام و ممکن است کمی ناراحت شوم.",
            "ب": "فورا عصبانی می شوم و به او می گویم که چرا نظر مرا نادیده گرفته است.",
            "ج": "تصمیم او را می پذیرم و به او احترام می گذارم، حتی اگر با نظر من متفاوت باشد.",
            "د": "ممکن است سعی کنم او را متقاعد کنم که تصمیم اشتباهی گرفته است و باید نظر مرا قبول کند.",
            "ه": "بسته به اهمیت موضوع و میزان مخالفتم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 2,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "هر چقدر که لازم باشد، باید تمام وقت و انرژی خود را به رابطه اختصاص داد و اولویت اصلی رابطه باشد.",
            "ب": "رابطه باید بخشی از زندگی باشد، اما نباید تمام زندگی را فرا بگیرد و باید به سایر جنبه های زندگی هم توجه کرد.",
            "ج": "میزان زمان و انرژی بستگی به مراحل مختلف رابطه دارد؛ در ابتدای رابطه باید زمان بیشتری اختصاص داد.",
            "د": "میزان زمان و انرژی بستگی به نیازهای هر دو طرف دارد و باید توافقی باشد.",
            "ه": "بسته به شرایط زندگی و تعهدات فردی، میزان زمان و انرژی می تواند متفاوت باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 5,
    ...
    },
    {
        ...
        "options": {
            "الف": "شوخی او را تحمل می کنم و فکر می کنم نباید حساسیت بیش از حد نشان دهم.",
            "ب": "فورا عصبانی می شوم و به او می گویم که شوخی اش اصلا خنده دار نبود و مرا ناراحت کرد.",
            "ج": "به آرامی با او صحبت می کنم و توضیح می دهم که چرا این موضوع برایم حساس است و این نوع شوخی ها را دوست ندارم.",
            "د": "ممکن است سکوت کنم و از او فاصله بگیرم تا ناراحتی ام کمتر شود.",
            "ه": "بسته به نوع شوخی و حالم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 2,
    ...
    },
    {
        ...
        "options": {
            "الف": "تصمیم می گیرم این موضوع را نادیده بگیرم و فکر می کنم مهم نیست چه می گوید.",
            "ب": "فورا عصبانی می شوم و رابطه را تمام می کنم، چون غیبت غیرقابل قبول است.",
            "ج": "به آرامی با او صحبت می کنم و می پرسم چرا این کار را می کند و به او می گویم که غیبت کردن مرا ناراحت می کند و به رابطه آسیب می زند.",
            "د": "ممکن است سکوت کنم و از او فاصله بگیرم تا ناراحتی ام کمتر شود.",
            "ه": "بسته به میزان غیبت و شرایط، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "به او می گویم که اهدافش غیرواقعی است و بهتر است به دنبال چیزهای عملی تر باشد.",
            "ب": "فورا بی حوصله می شوم و بحث را عوض می کنم.",
            "ج": "با دقت به حرف هایش گوش می دهم، سوال می پرسم و سعی می کنم درکش کنم، حتی اگر با اهدافش موافق نباشم.",
            "د": "ممکن است وانمود کنم که به حرف هایش گوش می دهم، اما در واقع توجهی نمی کنم.",
            "ه": "بسته به میزان علاقه ام به موضوع و حالم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "شباهت زیاد در همه زمینه ها برای یک رابطه موفق ضروری است.",
            "ب": "شباهت مهم نیست و تفاوت ها جذابیت رابطه را بیشتر می کند.",
            "ج": "شباهت در ارزش ها و اصول اساسی زندگی مهم است، اما تفاوت ها می توانند رابطه را غنی تر کنند.",
            "د": "میزان شباهت بستگی به ترجیحات شخصی دارد؛ برخی افراد شباهت بیشتر و برخی تفاوت بیشتر را ترجیح می دهند.",
            "ه": "بسته به نوع رابطه و اهداف مشترک، میزان شباهت می تواند متفاوت باشد."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
    ...
    },
    {
        ...
        "options": {
            "الف": "فکر می کنم من حتما اشتباه می کنم و سعی می کنم رفتارم را تغییر دهم تا او را راضی کنم.",
            "ب": "فورا عصبانی می شوم و با او دعوا می کنم.",
            "ج": "به آرامی با او صحبت می کنم و به او می گویم که انتقادهای مداوم و تحقیر کردن مرا ناراحت می کند و رابطه را تخریب می کند.",
            "د": "ممکن است سکوت کنم و از او فاصله بگیرم تا ناراحتی ام کمتر شود.",
            "ه": "بسته به میزان انتقاد و تحقیر و حالم، واکنش متفاوتی نشان می دهم."
        },
        "scores": {
            "الف": 1,
            "ب": 2,
    ...
    },
    {
        ...
        "options": {
            "الف": "هر زمان که رابطه دیگر مثل روزهای اول هیجان انگیز نباشد، باید به فکر پایان دادن به آن بود.",
            "ب": "فقط در صورتی که خیانت رخ دهد باید به فکر پایان دادن به رابطه بود.",
            "ج": "وقتی تلاش ها برای حل مشکلات و بهبود رابطه بی نتیجه باشد و رابطه به طور مداوم آسیب زننده باشد، باید به فکر پایان دادن به آن بود.",
            "د": "پایان دادن به رابطه همیشه آخرین راه حل است و باید تا آخرین لحظه برای حفظ آن تلاش کرد.",
            "ه": "بسته به شرایط رابطه و میزان نارضایتی، تصمیم متفاوتی می گیرم."
        },
        "scores": {
            "الف": 1,
            "ب": 1,
