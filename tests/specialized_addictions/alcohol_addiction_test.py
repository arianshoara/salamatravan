...
async def start_alcohol_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
alcohol_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_alcohol', start_alcohol_addiction_test)],
    states={
