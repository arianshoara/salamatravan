...
async def start_sedatives_sleeping_pills_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
sedatives_sleeping_pills_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_sedatives', start_sedatives_sleeping_pills_addiction_test)],
    states={
