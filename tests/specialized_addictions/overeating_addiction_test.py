...
async def start_overeating_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
overeating_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_overeating_addiction', start_overeating_addiction_test)],
    states={
