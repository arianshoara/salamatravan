...
async def start_excessive_exercise_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
excessive_exercise_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_exercise', start_excessive_exercise_addiction_test)],
    states={
