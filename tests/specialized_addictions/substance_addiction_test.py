...
async def start_substance_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
substance_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_alcohol_addiction', start_substance_addiction_test)],
    states={
