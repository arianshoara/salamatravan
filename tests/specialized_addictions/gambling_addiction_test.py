...
async def start_gambling_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
gambling_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_gambling', start_gambling_addiction_test)],
    states={
