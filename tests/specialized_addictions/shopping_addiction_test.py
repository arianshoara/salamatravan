...
async def start_shopping_addiction_test(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
shopping_addiction_conversation_handler = ConversationHandler(
    entry_points=[CommandHandler('start_shopping_addiction', start_shopping_addiction_test)],
    states={
