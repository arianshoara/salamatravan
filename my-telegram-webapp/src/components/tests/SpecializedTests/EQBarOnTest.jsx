...
// تولید 40 سوال به‌صورت داینامیک
  ...
  const qs = [
    {
      ...
      options: [
        ...
        { text: 'به راحتی تغییرات را می پذیرم و به دنبال فرصت های جدید می گردم.', value: 4, analysis: 'نمره بالا در انعطاف پذیری.' },
      ]
    },
    {
      id: 2,
...
const EQBarOnTest = () => {
  ...
  // محاسبه امتیاز کل و درصد نهایی
  const totalScore = Object.values(answers).reduce((acc, curr) => acc + curr, 0);
  const maxScore = questions.length * 4; // بیشترین امتیاز در هر سوال 4 است
  const percentage = Math.round((totalScore / maxScore) * 100);

  // تحلیل کلی بر اساس درصد کسب شده
  let overallAnalysis = '';
  let detailedAnalysis = ''; // تحلیل جزئی تر
  if (percentage >= 80) {
    overallAnalysis = "هوش هیجانی بسیار بالا";
    detailedAnalysis = "شما در بیشتر جنبه‌های هوش هیجانی عملکرد بسیار خوبی دارید. توانایی بالایی در شناخت و مدیریت احساسات خود و دیگران دارید و به خوبی با شرایط مختلف سازگار می‌شوید.";
  } else if (percentage >= 60) {
    overallAnalysis = "هوش هیجانی بالا";
    detailedAnalysis = "هوش هیجانی شما بالاتر از حد متوسط است. در بیشتر زمینه‌ها عملکرد خوبی دارید، اما هنوز جای پیشرفت وجود دارد.";
  } else if (percentage >= 40) {
    overallAnalysis = "هوش هیجانی متوسط";
    detailedAnalysis = "هوش هیجانی شما در سطح متوسط قرار دارد. برای بهبود عملکرد خود در برخی از زمینه‌ها می‌توانید تلاش کنید.";
  } else {
    overallAnalysis = "هوش هیجانی پایین";
    detailedAnalysis = "هوش هیجانی شما نیاز به تقویت دارد. با تمرین و تلاش می‌توانید مهارت‌های هوش هیجانی خود را بهبود بخشید.";
  }

  return (
    <div className="eq-test-container">
      <h1>تست هوش هیجانی (EQ) بار-آن</h1>
      ...
      {!showResult ? (
        ...
        <div className="result">
          ...
          <p>امتیاز شما: {percentage}%</p>
          <p>تجزیه و تحلیل کلی: {overallAnalysis}</p>
          <p>تفسیر کامل: {detailedAnalysis}</p> {/* نمایش تحلیل جزئی تر */}
        </div>
      )}
    </div>
  );
